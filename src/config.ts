...
export const siteConfig: SiteConfig = {
	title: "读档与书页",
	subtitle: "阅读、游戏与生活感想的个人博客",
	siteURL: "https://my-blog-zeta-lyart.vercel.app", // 请替换为你的站点URL，以斜杠结尾
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/my-banner.jpg.jpg",
			], // 桌面横幅图片
			mobile: [
				"/assets/desktop-banner/my-banner.jpg.jpg",
			], // 移动横幅图片
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/avatar-new.jpg.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "厦门思明区最忧郁之人",
	bio: "保持学习，保持平静",
	typewriter: {
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "欢迎来到HandserWu的blog", // 公告内容
